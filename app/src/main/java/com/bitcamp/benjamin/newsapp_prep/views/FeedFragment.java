...
public class FeedFragment extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        final Article clickedArticle = (Article) getListAdapter().getItem(position);
        Log.d("TESTTAG", clickedArticle.getId().toString());
        goToArticle.putExtra(ArticleFragment.EXTRA_ARTICLE_ID, clickedArticle.getId());
        /*
        Log.d("TESTTAG", clickedArticle.getTitle());
        */
    ...
    private class ArticleAdapter extends ArrayAdapter<Article>{
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null){
                convertView = getActivity().getLayoutInflater().inflate(R.layout.feed_fragment, null);
            }

            TextView articleTitle = (TextView)convertView.findViewById(R.id.article_title);
            articleTitle.setText(currentArticle.getTitle());
            if(currentArticle.isRead() == false){
                articleTitle.setTextColor(getResources().getColor(R.color.highlighted_text_material_light));
            }
            TextView articleContent = (TextView) convertView.findViewById(R.id.article_content);

            articleContent.setText(currentArticle.getPreview());
